<template>
  ...
  <accident v-else-if="getEventType == 4 && getSwitched == true" > </accident>
  <kidnapping v-else-if="getEventType == 3 && getSwitched == true" > </kidnapping>
  <shootingSttack v-else-if="getEventType == 1 && getSwitched == true" > </shootingSttack>
  <stabbingAttack v-else-if="getEventType == 2 && getSwitched == true" > </stabbingAttack>
